...
So we usually create users in the system and those users login to the system to perform . But a normal user cannot do the admin activities and also we cannot login with ROOT user, 