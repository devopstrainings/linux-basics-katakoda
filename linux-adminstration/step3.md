...
Sudoers Configuration is available in the system, So need to customize that configuration and which users can perform which activities and them system allows only that users to perform those commands.
