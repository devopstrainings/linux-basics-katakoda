...
**NOTE:** Unlike Windows, Linux filesystems are Case-Sensitive ones. Meaning the file `note.txt` & `NOTE.txt` can be referred as two different files. But windows `FAT` & `NTFS` filesystem will 
