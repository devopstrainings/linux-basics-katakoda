# General Preparation
#curl -s https://raw.githubusercontent.com/devopstrainings/linux-basics-katakoda/master/linux-cli-syntaxes/assets/foreground.sh | bash 
...
echo -e "\e[32mHost ready for use now\e[0m"